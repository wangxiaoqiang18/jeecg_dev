...
<body style="overflow-x: hidden;">
<form id="formobj" action="cgreportConfigHeadController.do?doUpdate" name="formobj" method="post"><input type="hidden"
                                                                                                         id="btn_sub"
                                                                                                         class="btn_sub"/>
    <input id="id" name="id" type="hidden" value="${cgreportConfigHeadPage.id }">
    <table cellpadding="0" cellspacing="1" class="formtable">
        <tr>
            ...
            <td class="value"><input id="code" name="code" type="text" style="width: 150px" class="inputxt" datatype="*"
                                     value='${cgreportConfigHeadPage.code}'> <span class="Validform_checktip"></span></td>
            ...
            <td class="value"><input id="name" name="name" type="text" style="width: 150px" class="inputxt" datatype="*"
                                     value='${cgreportConfigHeadPage.name}'> <span class="Validform_checktip"></span></td>
            <td align="right"><label class="Validform_label">数据源 :</label></td>
            <td class="value">
                <select name="dbSource">
                    <option value=""></option>
                    <c:forEach items="${sourceList}" var="item">
                        <option value="${item.dbName}" <c:if test="${cgreportConfigHeadPage.dbSource != null && item.dbName eq cgreportConfigHeadPage.dbSource}"> selected="selected"</c:if>>${item.dbKey}</option>
                    </c:forEach>
                </select>
        ...
        <tr>
            ...
            <td class="value" colspan="5"><textarea rows="5" cols="150" id="cgrSql" name="cgrSql" datatype="*">${cgreportConfigHeadPage.cgrSql}</textarea>
        ...
        <tr>
            ...
            <td class="value" colspan="5"><textarea rows="3" cols="150" id="content" name="content">测试多数据源功能</textarea>
                <span class="Validform_checktip"></span></td>
        ...
        <tr>
            ...
            <td class="value"><input id="returnValField" name="returnValField" type="text" style="width: 150px"
                                     class="inputxt" value="${cgreportConfigHeadPage.returnValField}"> <span class="Validform_checktip"></span></td>
            ...
            <td class="value"><input id="returnTxtField" name="returnTxtField" type="text" style="width: 150px"
                                     class="inputxt" value="${cgreportConfigHeadPage.returnTxtField}"> <span class="Validform_checktip"></span></td>
            <td align="right"><label class="Validform_label">返回类型:</label></td>
            <td class="value" colspan="3"><select name="popRetype">
                <option value=""></option>
                <option value="1" <c:if test="${cgreportConfigHeadPage.popRetype != null && cgreportConfigHeadPage.popRetype eq '1'}"> selected="selected"</c:if>>单选</option>
                <option value="2" <c:if test="${cgreportConfigHeadPage.popRetype != null && cgreportConfigHeadPage.popRetype eq '2'}"> selected="selected"</c:if>>多选</option>
    ...
    <div style="width: auto; ">
        ...
        <div id="ttp" tabPosition="top" border=flase style="margin:0px;padding:0px;overflow-x:hidden;width:auto;"
            ...
            <div title="报表参数" iconCls="icon-search"
