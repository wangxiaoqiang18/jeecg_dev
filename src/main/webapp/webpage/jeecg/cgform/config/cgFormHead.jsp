...
<head>
    ...
    <script type="text/javascript" src="${basepath}plug-in/cgform/js/cgformField.js"></script>
...
<form id="formobj" action="cgFormHeadController.do?save" name="formobj" method="post"><input type="hidden" id="btn_sub" class="btn_sub">
    <!-- tiptype="1" -->
    ...
    <div id="tabs" class="easyui-tabs" tabPosition="top" fit="false"
        ...
        <div title='数据库属性' width="auto" style="width: auto; margin: 0px; padding: 0px; overflow: hidden;">
            ...
            <div style="height: 25px;" class="datagrid-toolbar"><a id="addColumnBtn" class="easyui-linkbutton"
                                                                   ...
                                                                   onclick="addColumnBtnClick();" href="#">添加</a> <a
                    id="delColumnBtn" class="easyui-linkbutton" data-options="iconCls:'icon-remove'"
                    onclick="delColumnBtnClick();" href="#">删除</a></div>
        ...
        <div title='索引' style="overflow: hidden;">
            <div style="height: 25px;" class="datagrid-toolbar">
                <a id="addColumnBtn1" class="easyui-linkbutton" data-options="iconCls:'icon-add'"
                   onclick="addIndexBtnClick();" href="#">添加</a>
                <a id="delColumnBtn1" class="easyui-linkbutton" data-options="iconCls:'icon-remove'"
                   onclick="delIndexBtnClick();" href="#">删除</a>
            </div>
